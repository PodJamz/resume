...
Bilingual Creative Technologist and Product Designer/Builder/Developer/Engineer/Architect who loves to superpower my workflow using the latest AI powered tools such as Cursor IDE. With 12+ years of experience leading high-impact teams and shipping innovative products across startups and scale-ups, I thrive in high-agency, high-ownership roles—taking ideas from problem definition to production, iterating rapidly, and learning directly from real users. My passion is building AI-native, cloud-first solutions that deliver real business value. I lead by example, mentor others, and champion a culture of experimentation, autonomy, and pragmatic problem-solving. I’m at my best when I’m building what’s next, not waiting for someone else’s playbook.
