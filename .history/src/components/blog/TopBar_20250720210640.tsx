  ...
  return (
    <header className="flex items-center justify-between px-6 py-3 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="ml-4 px-3 py-1 rounded bg-zinc-100 dark:bg-zinc-800 text-xs font-mono text-zinc-500 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700">AI James</div>
      </div>
      {/* Center: search */}
