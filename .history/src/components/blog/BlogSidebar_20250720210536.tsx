    ...
    <aside className="w-[280px] min-h-screen flex flex-col justify-between bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 p-4">
      <div>
        <div className="flex items-center mb-8">
          <svg width="20" height="20" fill="none" viewBox="0 0 20 20" className="mr-2 text-zinc-600 dark:text-zinc-400">
            <path d="M3 4a1 1 0 011-1h3l2 3h6a1 1 0 011 1v8a1 1 0 01-1 1H4a1 1 0 01-1-1V4z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span className="font-bold text-lg tracking-tight">GoodWriter™</span>
        </div>
